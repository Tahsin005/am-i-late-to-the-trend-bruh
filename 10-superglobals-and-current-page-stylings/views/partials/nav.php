    ...
    <nav class="bg-gray-800/50">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/about.php" class="<?php if ($_SERVER["REQUEST_URI"] == '/about.php') {echo 'bg-gray-950/50'; } ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
                <a href="/contact.php" class="<?php if ($_SERVER["REQUEST_URI"] == '/contact.php') {echo 'bg-gray-950/50'; } ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
              </div>
            </div>
          </div>
      ...
      <el-disclosure id="mobile-menu" hidden class="block md:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
          ...
          <a href="/about.php" class="<?php if ($_SERVER["REQUEST_URI"] == '/about.php') {echo 'bg-gray-950/50'; } ?> block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
          <a href="/contact.php" class="<?php if ($_SERVER["REQUEST_URI"] == '/contact.php') {echo 'bg-gray-950/50'; } ?> block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
        </div>
